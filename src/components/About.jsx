      ...
      <div className="w-full max-w-[1000px] text-center">
        ...
        <div className="w-[95%] md:w-[80%] mx-auto bg-[rgba(0,255,247,0.03)] border border-[#00fff7]/20 p-6 md:p-12 rounded-[24px] backdrop-blur-[10px] shadow-[0_4px_30px_rgba(0,255,247,0.05)] text-justify md:text-center mb-16">
          <p className="font-['Orbitron'] text-[13px] md:text-[16px] leading-[1.8] mb-6 text-gray-200 tracking-wide">
            ...
            , I am a Computer Science graduate who enjoys building systems that
            solve real-world problems. During my studies, I developed both web
            and mobile applications using HTML, CSS, JavaScript, React, Java,
            and Python. Also learned software development, programming, database
            management, web development, and system analysis. Developed academic
            projects focused on building practical and user-friendly
            applications while strengthening problem-solving and technical
            skills.
          </p>
        </div>
